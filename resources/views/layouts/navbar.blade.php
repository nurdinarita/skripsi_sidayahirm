<div class="navbar-wrapper">
    ...
    <div class="navbar-logo">
        ...
        <a href="index.html">
            <img class="img-fluid" src="{{asset('assets/images/logo-dayah.png')}}" alt="Theme-Logo" />
        </a>
    ...
    <div class="navbar-container container-fluid">
        ...
        <ul class="nav-right">
            ...
            <li class="user-profile header-notification">
                <a href="#!">
                    <img src="{{asset('assets/images/user1.png')}}" class="img-radius" alt="User-Profile-Image">
