                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Input Data Pendidik</h5>
                                <div class="card-header-right"> <i class="icofont icofont-spinner-alt-5"></i> </div>
                            </div>
                            <div class="card-block">
                                <form id="main" method="post" action="{{ route('pendidik.store')}}" novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="riwayat_pendidikan_terakhir" id="riwayat_pendidikan_terakhir">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('mapel') is-invalid @enderror" name="id_mapel" id="mapel">
                                                ...
                                                <option value="{{$pl->id}}">{{$pl->mapel}}</option>
                                                @endforeach
                                            </select>
                                            @error('mapel')
                                            <span class="invalid-feedback" role="alert">
