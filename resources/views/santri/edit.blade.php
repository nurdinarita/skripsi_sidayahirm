                    ...
                    <div class="col-lg-4">
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('pendidik.index') }}">Data Santri</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form id="main" method="post" action="{{ route('santri.update',$santri->id) }}" novalidate>
                                    @method('PATCH')
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nik</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nik" id="nik" value="{{$santri->nik}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nama" id="nama" value="{{$santri->nama}}">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input " type="radio" name="mukim_tidak" id="mukim_tidak-1" value="Ya"> Ya
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input " type="radio" name="mukim_tidak" id="mukim_tidak-2" value="tidak"> Tidak
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="provinsi" id="provinsi" value="{{$santri->provinsi}}">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="kabupaten" id="kabupaten" value="{{$santri->kabupaten}}">
                                            <span class="messages"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
